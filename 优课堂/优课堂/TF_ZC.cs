...
namespace 优课堂
{
    public partial class TF_ZC : Form
    {
        public TF_ZC()
        {
            InitializeComponent();
        ...
        {
            string sql = string.Format("insert into User_TF(userName,userPassword) values ('{0}','{1}')", user.Text.ToString(), password.Text.ToString());
